...
class VisualizeOptimization:
    ...
    def plot_best_params(self, num_trials = 10):
       ...
       # correlates to the change in the best value.
        ...
        plt.plot(trial_number, best_values, linewidth = 3.5, color = 'black', label = "Best Value [1-accuracy]", linestyle = "solid")
        plt.plot(trial_number, learning_rates, color = 'midnightblue', linestyle = "dotted", linewidth = 1, label = "Learning rates")
        plt.plot(trial_number, init_batch_sizes, color = "lightsalmon", linewidth = 2, linestyle = "dashed", label = "Initial (synthetic) batch sizes")
        plt.plot(trial_number, num_frozen_layer_array, color = "darkolivegreen", linewidth = 2, linestyle = "dashdot", label = "Number of Frozen Layers")
        plt.plot(trial_number, dropout_rates, color = "mediumturquoise", linewidth = 2, linestyle = (0, (10, 3)), label = "Dropout rate")
        plt.plot(trial_number, unfreeze_batch_sizes, color = "slategray", linewidth = 2, linestyle = (0, (5, 10)), label = "Batch Size during Unfreezing")
        plt.plot(trial_number, unfreeze_learning_rates, color = "crimson", linewidth = 2, linestyle = (0, (3, 10, 1, 10)), label = "Learning Rate used during Unfreezing")
        
        plt.plot(trial_number, np.zeros_like(unfreeze_learning_rates), color = 'black', linewidth = 1, linestyle = 'solid', label = "x-axis") # for seeing x axis
        plt.title(f"Optimization Best Values and Hyperparameters for {num_trials} Trials")
        plt.xlabel("Trial Number", fontsize = 12)
        plt.ylabel("Hyperparameter [varying units]", fontsize = 12)
        plt.yscale('log')
